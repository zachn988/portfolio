...
403 Godot Project: A simple dungeon crawler built in Godot engine, using GDScript in 1.5 months.
          In a 4-person team, my responsibilities included: Creating maps for the player to move around,
          Creating the 'shooting' action for both player and enemies
          Creating hitboxes and hurtboxes for player and enemies
...
Sport Trainer: A social media app for sport and fitness enthusiasts to connect and train together. Created in 5 months.
